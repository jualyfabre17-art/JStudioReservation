        ...
        <div style={styles.container}>
            <div style={styles.header}>
                <div style={styles.headerLeft}>
                    <h1 style={styles.title}>🎛️ Servicios Adicionales</h1>
                    <p style={styles.subtitle}>
                        Gestiona todos los servicios adicionales del estudio
                    </p>
                </div>
                <Link
                    to="/extraservices/create"
            ...
            <div style={styles.stats}>
                <div style={styles.statItem}>
                    ...
                    <span style={styles.statLabel}>Servicios registrados</span>
                </div>
                <div style={styles.statItem}>
                    <span style={styles.statNumber}>
                        {services.filter(s => s.price > 0).length}
                    </span>
                    <span style={styles.statLabel}>Con precio definido</span>
                </div>
            </div>
            ...
            <div style={styles.grid}>
                {services.length === 0 ? (
                    <p style={styles.emptyMessage}>
                        ...
                        <Link to="/extraservices/create" style={{ color: '#4f46e5', textDecoration: 'none', fontWeight: '500' }}>
                            {' '}Crea el primero
                        </Link>
                    </p>
                ) : (
                        ...
                        <div key={service.id} style={styles.card}>
                            <div style={styles.cardContent}>
                                ...
                                <p style={styles.cardText}>
                                    <span style={styles.cardTextStrong}>🎚️ Sala:</span> {roomNames[service.roomId] || 'Cargando...'}
                                </p>
                                <p style={styles.cardId}>ID: #{service.id}</p>
                            </div>
                            <div style={styles.cardActions}>
                                <Link
                                    to={`/extraservices/edit/${service.id}`}
